...
// Render posts
function aip_render_posts($articles, $shortcode_attr)
{
    ...
    <section class="<?php echo esc_attr($prefix); ?>">
        ...
        <?php foreach ($articles as $article) :
            echo aip_render_single_post($article, $prefix);
        endforeach; ?>
        </div>
    </section>
    <?php
...
// Render single post
function aip_render_single_post($article, $prefix)
{
...
function aip_handle_shortcode($atts)
{
    ...
    return !empty($articles) ? aip_render_posts($articles, $shortcode_attr) : '';
}
